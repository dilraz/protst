...
function SignIn() {
                  ...
                  let task = fire
                    ...
                    .then(() => {
                      fire
                        ...
                        .doc()
                        .set({
                          userId: 'r2MIYXJwa2cg1Qka9ERx8pC12sp1',
                        });
                    })
                    .then(() => {
        ...
        .then(cred => {
          firebase
            ...
            .set({
              ...
              bio: 'Hey! I am new here. Feel free to add me.',
              photoUrl:
                'https://firebasestorage.googleapis.com/v0/b/protst.appspot.com/o/photos%2Fuser.png?alt=media&token=bcd3ba4f-cd14-4b9f-9ddd-e05fada45f2f',
            })
            .then(() => {
              fire
                .firestore()
  ...
  const handleLogoutUnverified = () => {
    ...
    fire
      ...
      .then(window.alert('Please Verify Your Email!'));
  };
